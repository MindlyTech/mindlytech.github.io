        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
          ...
          <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            <div className="flex flex-col max-w-lg p-6 mx-auto text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                Our Dedicated Team model provides you with a full-time team of
                experts tailored to meet the specific needs of your project.
                This model is best for long-term collaborations where ongoing
                development and iterative improvement are required. It offers
                the benefits of having an in-house team, including seamless
                integration with your processes, dedicated resources, and
                consistent collaboration, all while maintaining
